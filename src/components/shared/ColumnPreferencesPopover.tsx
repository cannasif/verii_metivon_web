...
const isLockedColumn = (key: string): boolean => ['id', 'actions'].includes(key.toLowerCase());
    ...
    <div className="p-2 space-y-2">
      ...
      <div className="space-y-1 max-h-48 overflow-y-auto">
        {displayColumns.map((key) => {
          ...
          const hasId = displayColumns.some((item) => item.toLowerCase() === 'id');
          const hasActions = displayColumns.some((item) => item.toLowerCase() === 'actions');
          const firstMovableIndex = hasId ? 1 : 0;
          const lastMovableIndex = displayColumns.length - (hasActions ? 2 : 1);
          return (
            <div
              key={key}
