      ...
      <div className="flex flex-wrap gap-4 pt-2 border-t border-zinc-100 dark:border-white/5 mt-2">
         {stock.createdAt && (
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-zinc-50 dark:bg-white/5 text-xs text-zinc-500 border border-zinc-200 dark:border-white/5">
                ...
                <span>{t('stock.detail.created')}: <span className="font-semibold text-zinc-700 dark:text-zinc-300">{formatSystemDate(stock.createdAt)}</span></span>
            </div>
         )}
         {stock.updatedAt && (
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-zinc-50 dark:bg-white/5 text-xs text-zinc-500 border border-zinc-200 dark:border-white/5">
                <CheckCircle2 className="w-3.5 h-3.5 text-zinc-400" />
                <span>{t('stock.detail.updated')}: <span className="font-semibold text-zinc-700 dark:text-zinc-300">{formatSystemDate(stock.updatedAt)}</span></span>
            </div>
         )}
      </div>
