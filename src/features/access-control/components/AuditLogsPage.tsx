...
export function AuditLogsPage(): ReactElement {
  ...
  const [entityLookupType, setEntityLookupType] = useState('PermissionDefinition');
            ...
            leftSlot={
              <div className="flex flex-wrap items-center gap-2">
                <Select value={entityLookupType} onValueChange={setEntityLookupType}>
                  ...
                  <SelectContent>
                    <SelectItem value="PermissionDefinition">İzin tanımı</SelectItem>
                    <SelectItem value="PermissionGroup">İzin grubu</SelectItem>
                    <SelectItem value="UserPermissionGroup">Kullanıcı grup ataması</SelectItem>
                    <SelectItem value="VisibilityPolicy">Görünürlük politikası</SelectItem>
                    <SelectItem value="UserVisibilityPolicy">Kullanıcı görünürlük ataması</SelectItem>
                  </SelectContent>
                </Select>
                <Input
