...
const ENTITY_ACCENT_MAP: Record<string, string> = {
  BusinessPartner: 'violet', Product: 'rose', Warehouse: 'sky', Inventory: 'emerald',
  GoodsReceipt: 'emerald', TransferOrder: 'amber', Shipment: 'rose', PurchaseOrder: 'violet',
  SalesOrder: 'sky', ImportDossier: 'amber', ElectronicDocument: 'violet', Accounting: 'emerald',
};
