                    ...
                    <div className="flex w-full items-center justify-between gap-4 pr-3">
                      ...
                      <span className="flex items-center gap-2 text-xs font-semibold text-slate-600 dark:text-slate-300">
                        <span
                          aria-hidden
                          className={cn(
                            'size-2.5 rounded-full border border-slate-300 dark:border-white/20',
                            moduleSelected && 'border-primary bg-primary'
                          )}
                        />
                        {moduleIds.filter((id) => value.includes(id)).length}/{moduleIds.length}
                      </span>
                    </div>
                  </AccordionTrigger>
