...
export function VisibilitySimulatorPage(): ReactElement {
  ...
  const [selectedEntityType, setSelectedEntityType] = useState<string>('BusinessPartner');
  ...
  const selectedEntityLabel = t(selectedEntityMeta?.labelKey ?? 'visibilityPolicies.entity.businessPartner', {
