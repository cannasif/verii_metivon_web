...
export const ROUTE_PERMISSION_MAP: Record<string, string> = {
  '/': 'dashboard.view',
  '/accounts': 'accounts.account-management.view',
  '/accounts/definitions': 'accounts.definitions.view',
  '/accounts/definitions/partner-types': 'accounts.partner-types.view',
  '/accounts/definitions/customer-groups': 'accounts.customer-groups.view',
  '/accounts/definitions/payment-terms': 'accounts.payment-terms.view',
  '/accounts/definitions/currencies': 'accounts.currencies.view',
  '/accounts/definitions/tax-groups': 'accounts.tax-groups.view',
  '/accounts/parameters': 'accounts.parameters.view',
  '/products/definitions/categories': 'products.categories.view',
  '/products/definitions/groups': 'products.groups.view',
  '/products/definitions/brands': 'products.brands.view',
  '/products/definitions/unit-categories': 'products.unit-categories.view',
  '/products/definitions/units': 'products.units.view',
  '/products/definitions/package-types': 'products.package-types.view',
  '/warehouses': 'warehouses.warehouse-management.view',
  '/warehouses/new': 'warehouses.warehouse-management.create',
  '/warehouses/locations': 'warehouses.storage-locations.view',
  '/warehouses/locations/new': 'warehouses.storage-locations.create',
  '/inventory/balances': 'inventory.balances.view',
  '/inventory/transactions': 'inventory.transactions.view',
  '/inventory/tracking-parameters': 'inventory.tracking-parameters.view',
  '/purchase-orders': 'procurement.purchase-orders.view',
  '/purchase-orders/new': 'procurement.purchase-orders.create',
  '/purchase-orders/parameters': 'procurement.parameters.view',
  '/goods-receipts': 'receiving.goods-receipts.view',
  '/goods-receipts/new': 'receiving.goods-receipts.create',
  '/goods-receipts/parameters': 'receiving.parameters.view',
  '/transfer-orders': 'transfers.transfer-orders.view',
  '/transfer-orders/new': 'transfers.transfer-orders.create',
  '/transfer-orders/parameters': 'transfers.parameters.view',
  '/sales-orders': 'sales.sales-orders.view',
  '/sales-orders/new': 'sales.sales-orders.create',
  '/sales-orders/parameters': 'sales.parameters.view',
  '/pricing/price-lists': 'pricing.price-lists.view',
  '/pricing/price-lists/new': 'pricing.price-lists.create',
  '/pricing/parameters': 'pricing.parameters.view',
  '/shipments': 'shipping.shipments.view',
  '/shipments/new': 'shipping.shipments.create',
  '/shipments/parameters': 'shipping.parameters.view',
  '/inventory-counts': 'counting.inventory-counts.view',
  '/inventory-counts/new': 'counting.inventory-counts.create',
  '/inventory-counts/parameters': 'counting.parameters.view',
  '/e-documents': 'e-documents.e-documents.view',
  '/e-documents/parameters': 'e-documents.parameters.view',
  '/accounting/accounts': 'accounting.ledger-accounts.view',
  '/accounting/accounts/new': 'accounting.ledger-accounts.create',
  '/accounting/journals': 'accounting.journal-entries.view',
  '/accounting/journals/new': 'accounting.journal-entries.create',
  '/accounting/parameters': 'accounting.parameters.view',
  '/accounting/definitions/fiscal-periods': 'accounting.fiscal-periods.view',
  '/accounting/definitions/inventory-posting-profiles': 'accounting.inventory-posting-profiles.view',
  '/import-dossiers': 'landed-costs.import-dossiers.view',
  '/import-dossiers/costs/new': 'landed-costs.import-dossiers.update',
  '/import-dossiers/new': 'landed-costs.import-dossiers.create',
  ...
  '/stocks': 'products.product-management.view',
  '/stocks/:id': 'products.product-management.view',
  '/purchase-orders/number-series': 'procurement.number-series.view',
  '/purchase-orders/number-series/new': 'procurement.number-series.create',
  '/purchase-orders/number-series/usages': 'procurement.number-series.view',
  '/goods-receipts/number-series': 'receiving.number-series.view',
  '/goods-receipts/number-series/new': 'receiving.number-series.create',
  '/goods-receipts/number-series/usages': 'receiving.number-series.view',
  '/transfer-orders/number-series': 'transfers.number-series.view',
  '/transfer-orders/number-series/new': 'transfers.number-series.create',
  '/transfer-orders/number-series/usages': 'transfers.number-series.view',
  '/sales-orders/number-series': 'sales.number-series.view',
  '/sales-orders/number-series/new': 'sales.number-series.create',
  '/sales-orders/number-series/usages': 'sales.number-series.view',
  '/shipments/number-series': 'shipping.number-series.view',
  '/shipments/number-series/new': 'shipping.number-series.create',
  '/shipments/number-series/usages': 'shipping.number-series.view',
  '/e-documents/number-series': 'e-documents.number-series.view',
  '/e-documents/number-series/new': 'e-documents.number-series.create',
  '/e-documents/number-series/usages': 'e-documents.number-series.view',
  ...
  '/settings/branches': 'organization.branches.view',
  '/settings/branches/new': 'organization.branches.create',
  ...
  '/access-control/permission-definitions': 'access-control.permission-groups.view',
...
export const PATH_TO_PERMISSION_PATTERNS: Array<{ pattern: RegExp; permission: string }> = [
  ...
  { pattern: /^\/accounts\/definitions\/partner-types(\/|$)/, permission: 'accounts.partner-types.view' },
  { pattern: /^\/accounts\/definitions\/customer-groups(\/|$)/, permission: 'accounts.customer-groups.view' },
  { pattern: /^\/accounts\/definitions\/payment-terms(\/|$)/, permission: 'accounts.payment-terms.view' },
  { pattern: /^\/accounts\/definitions\/currencies(\/|$)/, permission: 'accounts.currencies.view' },
  { pattern: /^\/accounts\/definitions\/tax-groups(\/|$)/, permission: 'accounts.tax-groups.view' },
  { pattern: /^\/accounts\/definitions(\/|$)/, permission: 'accounts.definitions.view' },
  { pattern: /^\/accounts\/parameters(\/|$)/, permission: 'accounts.parameters.view' },
  { pattern: /^\/accounts(\/|$)/, permission: 'accounts.account-management.view' },
  { pattern: /^\/products\/definitions\/categories(\/|$)/, permission: 'products.categories.view' },
  { pattern: /^\/products\/definitions\/groups(\/|$)/, permission: 'products.groups.view' },
  { pattern: /^\/products\/definitions\/brands(\/|$)/, permission: 'products.brands.view' },
  { pattern: /^\/products\/definitions\/unit-categories(\/|$)/, permission: 'products.unit-categories.view' },
  { pattern: /^\/products\/definitions\/units(\/|$)/, permission: 'products.units.view' },
  { pattern: /^\/products\/definitions\/package-types(\/|$)/, permission: 'products.package-types.view' },
  { pattern: /^\/warehouses\/locations\/new(\/|$)/, permission: 'warehouses.storage-locations.create' },
  { pattern: /^\/warehouses\/locations(\/|$)/, permission: 'warehouses.storage-locations.view' },
  { pattern: /^\/warehouses\/new(\/|$)/, permission: 'warehouses.warehouse-management.create' },
  { pattern: /^\/warehouses(\/|$)/, permission: 'warehouses.warehouse-management.view' },
  { pattern: /^\/settings\/branches\/new(\/|$)/, permission: 'organization.branches.create' },
  { pattern: /^\/settings\/branches\/\d+\/edit(\/|$)/, permission: 'organization.branches.update' },
  { pattern: /^\/settings\/branches(\/|$)/, permission: 'organization.branches.view' },
  ...
  { pattern: /^\/purchase-orders\/parameters(\/|$)/, permission: 'procurement.parameters.view' },
  { pattern: /^\/purchase-orders(\/|$)/, permission: 'procurement.purchase-orders.view' },
  { pattern: /^\/goods-receipts\/number-series\/new(\/|$)/, permission: 'receiving.number-series.create' },
  { pattern: /^\/goods-receipts\/number-series(\/|$)/, permission: 'receiving.number-series.view' },
  { pattern: /^\/goods-receipts\/new(\/|$)/, permission: 'receiving.goods-receipts.create' },
  { pattern: /^\/goods-receipts\/parameters(\/|$)/, permission: 'receiving.parameters.view' },
  { pattern: /^\/goods-receipts(\/|$)/, permission: 'receiving.goods-receipts.view' },
  { pattern: /^\/transfer-orders\/number-series\/new(\/|$)/, permission: 'transfers.number-series.create' },
  { pattern: /^\/transfer-orders\/number-series(\/|$)/, permission: 'transfers.number-series.view' },
  { pattern: /^\/transfer-orders\/new(\/|$)/, permission: 'transfers.transfer-orders.create' },
  { pattern: /^\/transfer-orders\/parameters(\/|$)/, permission: 'transfers.parameters.view' },
  { pattern: /^\/transfer-orders(\/|$)/, permission: 'transfers.transfer-orders.view' },
  { pattern: /^\/sales-orders\/number-series\/new(\/|$)/, permission: 'sales.number-series.create' },
  { pattern: /^\/sales-orders\/number-series(\/|$)/, permission: 'sales.number-series.view' },
  { pattern: /^\/sales-orders\/new(\/|$)/, permission: 'sales.sales-orders.create' },
  { pattern: /^\/sales-orders\/parameters(\/|$)/, permission: 'sales.parameters.view' },
  { pattern: /^\/sales-orders(\/|$)/, permission: 'sales.sales-orders.view' },
  { pattern: /^\/pricing\/price-lists\/new(\/|$)/, permission: 'pricing.price-lists.create' },
  { pattern: /^\/pricing\/price-lists(\/|$)/, permission: 'pricing.price-lists.view' },
  { pattern: /^\/pricing\/parameters(\/|$)/, permission: 'pricing.parameters.view' },
  { pattern: /^\/shipments\/number-series\/new(\/|$)/, permission: 'shipping.number-series.create' },
  { pattern: /^\/shipments\/number-series(\/|$)/, permission: 'shipping.number-series.view' },
  { pattern: /^\/shipments\/new(\/|$)/, permission: 'shipping.shipments.create' },
  { pattern: /^\/shipments\/parameters(\/|$)/, permission: 'shipping.parameters.view' },
  { pattern: /^\/shipments(\/|$)/, permission: 'shipping.shipments.view' },
  { pattern: /^\/inventory-counts\/new(\/|$)/, permission: 'counting.inventory-counts.create' },
  { pattern: /^\/inventory-counts\/parameters(\/|$)/, permission: 'counting.parameters.view' },
  { pattern: /^\/inventory-counts(\/|$)/, permission: 'counting.inventory-counts.view' },
  { pattern: /^\/e-documents\/number-series\/new(\/|$)/, permission: 'e-documents.number-series.create' },
  { pattern: /^\/e-documents\/number-series(\/|$)/, permission: 'e-documents.number-series.view' },
  { pattern: /^\/e-documents\/parameters(\/|$)/, permission: 'e-documents.parameters.view' },
  { pattern: /^\/e-documents(\/|$)/, permission: 'e-documents.e-documents.view' },
  { pattern: /^\/accounting\/accounts\/new(\/|$)/, permission: 'accounting.ledger-accounts.create' },
  { pattern: /^\/accounting\/accounts(\/|$)/, permission: 'accounting.ledger-accounts.view' },
  { pattern: /^\/accounting\/journals\/new(\/|$)/, permission: 'accounting.journal-entries.create' },
  { pattern: /^\/accounting\/journals(\/|$)/, permission: 'accounting.journal-entries.view' },
  { pattern: /^\/accounting\/parameters(\/|$)/, permission: 'accounting.parameters.view' },
  { pattern: /^\/accounting\/definitions\/fiscal-periods(\/|$)/, permission: 'accounting.fiscal-periods.view' },
  { pattern: /^\/accounting\/definitions\/inventory-posting-profiles(\/|$)/, permission: 'accounting.inventory-posting-profiles.view' },
  { pattern: /^\/import-dossiers\/new(\/|$)/, permission: 'landed-costs.import-dossiers.create' },
  { pattern: /^\/import-dossiers\/costs\/new(\/|$)/, permission: 'landed-costs.import-dossiers.update' },
  ...
  { pattern: /^\/stocks(\/|$)/, permission: 'products.product-management.view' },
  { pattern: /^\/purchase-orders\/number-series\/new(\/|$)/, permission: 'procurement.number-series.create' },
  { pattern: /^\/purchase-orders\/number-series(\/|$)/, permission: 'procurement.number-series.view' },
  { pattern: /^\/goods-receipts\/number-series\/new(\/|$)/, permission: 'receiving.number-series.create' },
  { pattern: /^\/goods-receipts\/number-series(\/|$)/, permission: 'receiving.number-series.view' },
  ...
  { pattern: /^\/access-control\/permission-definitions(\/|$)/, permission: 'access-control.permission-groups.view' },
