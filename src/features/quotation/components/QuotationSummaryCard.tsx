        ...
        <div className="mt-6 pt-5 space-y-3.5">
            ...
            <div className="mt-4 pt-5 border-t-2 border-zinc-200 dark:border-zinc-800">
              <div className="flex items-center justify-between gap-3">
                ...
                <span className="font-black font-mono tabular-nums text-right text-lg whitespace-nowrap shrink-0 text-transparent bg-clip-text bg-[image:var(--crm-brand-gradient)]">
