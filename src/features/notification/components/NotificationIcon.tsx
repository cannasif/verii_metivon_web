...
import { NOTIFICATIONS_ENABLED } from '../notification-features';

export function NotificationIcon(): ReactElement | null {
  ...
  useEffect(() => {
    if (!NOTIFICATIONS_ENABLED || !shouldFetchUnread || !userId) return;
