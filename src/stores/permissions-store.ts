...
export function isValidPermissionSnapshot(
  data: MyPermissionsDto | null | undefined,
  userId: number | null | undefined
): data is MyPermissionsDto {
  return Boolean(
    data &&
      userId &&
      data.userId === userId &&
      typeof data.roleTitle === 'string' &&
      typeof data.isSystemAdmin === 'boolean' &&
      Array.isArray(data.permissionGroups) &&
