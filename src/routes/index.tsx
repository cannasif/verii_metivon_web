  ...
  return createBrowserRouter([
    {
      ...
      children: [
        ...
        { path: 'warehouses/:id/edit', element: <WarehouseCreatePage /> },
        { path: 'warehouses/locations/new', element: <StorageLocationCreatePage /> },
        { path: 'warehouses/locations/:id/edit', element: <StorageLocationCreatePage /> },
        { path: 'purchase-orders/new', element: <PurchaseOrderCreatePage /> },
        { path: 'purchase-orders/:id/edit', element: <PurchaseOrderCreatePage /> },
        { path: 'transfer-orders/new', element: <TransferOrderCreatePage /> },
        { path: 'transfer-orders/:id/edit', element: <TransferOrderCreatePage /> },
        { path: 'inventory-counts/new', element: <InventoryCountCreatePage /> },
        { path: 'inventory-counts/:id/edit', element: <InventoryCountCreatePage /> },
        { path: 'pricing/price-lists/new', element: <PriceListCreatePage /> },
        { path: 'pricing/price-lists/:id/edit', element: <PriceListCreatePage /> },
        { path: 'accounting/accounts/new', element: <LedgerAccountCreatePage /> },
        { path: 'accounting/accounts/:id/edit', element: <LedgerAccountCreatePage /> },
        { path: 'goods-receipts/new', element: <GoodsReceiptCreatePage /> },
        { path: 'goods-receipts/:id/edit', element: <GoodsReceiptCreatePage /> },
        { path: 'sales-orders/new', element: <SalesOrderCreatePage /> },
        { path: 'sales-orders/:id/edit', element: <SalesOrderCreatePage /> },
        { path: 'shipments/new', element: <ShipmentCreatePage /> },
        { path: 'shipments/:id/edit', element: <ShipmentCreatePage /> },
        ...
        { path: 'import-dossiers/definitions/cost-types/:id/edit', element: <LandedCostTypeCreatePage /> },
